                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="field-set">
                                            ...
                                            <input type='text' name='FullName' id='name' class="form-control" value="${user_acc.full_name}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="field-set">
                                            ...
                                            <input type='text' name='email' id='email' class="form-control" value="${user_acc.email}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="field-set">
                                            <label>Country:</label>
                                            <input type='text' name='re-password' id='country' class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div id='submit' class="pull-left">
                                            <input type='submit' id='send_message'  onclick="document.getElementById('contact_form').submit()" value='Register Now' class="btn btn-main color-2">
                                        </div>
