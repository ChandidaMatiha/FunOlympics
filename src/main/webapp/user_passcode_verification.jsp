                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 offset-lg-1 wow fadeIn" data-wow-delay=".5s">
                                <div class="box-rounded padding40" data-bgcolor="#ffffff">
                                    <h3 class="mb10">Verification Code</h3>
                                    ...
                                    <form name="contactForm" id='contact_form' class="form-border" method="post" action='ServletOlympics'>
                                        ...
                                        <div class="field-set">
                                            <input type='text' name='codeVerify' id='email' class="form-control" placeholder="Code">
                                        </div>


                                        <div class="field-set">
                                            <input type='submit' id='send_message' onclick="document.getElementById('contact_form').submit()" value='Submit' class="btn btn-main btn-fullwidth color-2">
                                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-1">
                    <div class="widget">
                        ...
                        <form action="ServletOlympics" class="row form-dark" id="form_subscribe" method="post" name="form_subscribe">
                            <div class="col text-center">
                                <input class="form-control" id="txt_subscribe" name="email" placeholder="enter your email" type="text" /> <a href="#" id="btn-subscribe"><i class="arrow_right bg-color-secondary"></i></a>
                                <div class="clearfix"></div>
                            </div>
                        </form>
                        <div class="spacer-10"></div>
